...
<link href="<%=basePath%>style/css/main.css" rel="stylesheet" type="text/css" />
<link href="<%=basePath%>style/css/iconfont.css" rel="stylesheet" type="text/css" />
<link href="<%=basePath%>style/css/test.css" rel="stylesheet" type="text/css" />
<script src="<%=basePath%>style/js/jquery-1.11.3.min.js"></script>

<!--时间js-->
<script src="<%=basePath%>style/js/jquery.countdown.js"></script>
<script>
	$(function() {
